...
import bcrypt from 'bcrypt'; // Assurez-vous d'utiliser un environnement qui supporte les modules ES6

// Hachage du mot de passe
const password = 'lazaniaina2310'; // Le mot de passe à hacher
const saltRounds = 10;
...
bcrypt.hash(password, saltRounds, function(err, hash) {
  ...
  const passwordReceived = 'lazaniaina2310'; // Le mot de passe que vous avez reçu
